...
class LaTeX2Markdown(object):
    ...
    def __init__(self,  latex_string,
        ...
        self._block_re = re.compile(r"""\\begin{(?P<block_name>exer|proof|thm|lem|prop|problem|defn|rem|cor)} # block name
        ...
        self._lists_re = re.compile(r"""\\begin{(?P<block_name>enumerate|itemize|casenv)} # list name
    ...
    def _replace_block(self, matchobj):
        ...
        if block_name in {"itemize", "enumerate","casenv"}:
